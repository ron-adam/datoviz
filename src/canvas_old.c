...
//     dvz_images_memory(
//         &sc->staging, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT |
...
//     dvz_event_callback(canvas, DVZ_EVENT_RESIZE, 0, DVZ_EVENT_MODE_SYNC, _screencast_resize,
//     sc); dvz_event_callback(canvas, DVZ_EVENT_DESTROY, 0, DVZ_EVENT_MODE_SYNC,
//     _screencast_destroy, sc);
...
// void dvz_canvas_video(DvzCanvas* canvas, int framerate, int bitrate, const char* path, bool
// record)
// {
//     ASSERT(canvas != NULL);
