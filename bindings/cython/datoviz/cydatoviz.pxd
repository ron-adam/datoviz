...
cdef extern from "<datoviz/datoviz.h>":
    ...
    ctypedef enum DvzDataTransferType:
        ...
        DVZ_TRANSFER_BUFFER_DOWNLOAD_DONE = 3
        DVZ_TRANSFER_BUFFER_COPY = 4
        DVZ_TRANSFER_TEXTURE_UPLOAD = 5
        DVZ_TRANSFER_TEXTURE_DOWNLOAD = 6
        DVZ_TRANSFER_TEXTURE_DOWNLOAD_DONE = 7
        DVZ_TRANSFER_TEXTURE_COPY = 8
